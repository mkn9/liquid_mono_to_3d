...
# Import model from branch1 (same architecture)
...
def train_branch3():
    ...
    print(f"Branch 3 - Using device: {device}")
    ...
    print(f"Branch 3 Training complete! Best Val Acc: {best_val_acc:.3f}")
